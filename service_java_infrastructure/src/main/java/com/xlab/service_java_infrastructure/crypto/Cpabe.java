...
public class Cpabe {
    ...
    public static AbePrivateKey delegate(AbePrivateKey oldPrivateKey, String attributeSubset) throws Exception {
    ...
    public static void delegate(File oldPrivateKeyFile, String attributeSubset, File newPrivateKeyFile) throws Exception {

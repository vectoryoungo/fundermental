 ...
 * module: fundermental
 * file: SymmetricEncoder.java
 * date: 1/28/19 3:58 PM
 * author: VectorJu
 */

/**
 * @create 2019-01-28 15:58
 * @desc AES对称加密
 **/
...
public class SymmetricEncoder {
    ...
    public static void main(String[] args) {
        String encodeRules="afsfahfiweqwefsdfadfs";
        String content="中国的变革";
        String resultCrypto = AESEncode(encodeRules,content);

        System.out.println("加密后的密文为："+resultCrypto);
        System.out.println("解密后的明文为："+AESDncode(encodeRules,resultCrypto));
    }
    ...
    public static String AESEncode(String encodeRules,String content){
        try {
            ...
            //3.产生原始对称密钥
	            /*javax.crypto接口 SecretKey所有超级接口：Key, Serializable
	             * SecretKey
            ...
            //6.根据指定算法AES自成密码器
	             ...
	             * 常用方法byte[] doFinal() 结束多部分加密或解密操作（具体取决于此 Cipher 的初始化方式）。
	             */
